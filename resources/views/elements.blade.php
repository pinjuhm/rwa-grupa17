...
<div class="super_container">
						...
						<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
							...
							<nav class="main_nav">
								<ul class="d-flex flex-row align-items-start justify-content-start">
									<li class="active"><a href="indssex.blade.php">Home</a></li>
	...
	<div class="home">
		<div class="background_image" style="background-image:url(http://grupa17.test/images/elements.jpg)"></div>
	</div>
	...
	<footer class="footer">
		<div class="background_image" style="background-image:url(http://grupa17.test/images/footer_1.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
